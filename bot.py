...
def send_welcome(message):
    ...
    bot.reply_to(
        message,
        "Hi, I'm ExpeditionExpertBot! I'll help you source cheap flights and hotels. /flight or /hotel to begin.",
        reply_markup=markup,
    )
...
def search_flights(message):
    ...
    if flight_info:
        ...
        flight_search_results = kiwi_flight_search(
            fly_from, fly_to, date_from, date_to, return_from, return_to, partner_market
        )
